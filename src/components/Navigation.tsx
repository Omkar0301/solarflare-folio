  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          <div className="hidden md:flex items-center space-x-1 lg:space-x-2">
            {navLinks.map((link) => (
              <a
                ...
                className="px-2 lg:px-3 xl:px-4 py-2 text-xs lg:text-sm xl:text-base text-foreground hover:text-primary transition-smooth font-medium"
              >
                {link.label}
              </a>
            ))}
          ...
          <div className="hidden md:flex items-center space-x-2">
            ...
            <Button
              ...
              size="sm"
              className="bg-primary hover:bg-primary-dark text-primary-foreground shadow-glow text-xs lg:text-sm"
            >
              {t('nav.getQuote')}
            </Button>
          </div>
        ...
        {/* Mobile Menu */}
        {isMobileMenuOpen && (
          <div className="md:hidden py-4 animate-slide-up bg-background/95 backdrop-blur-md fixed left-0 right-0 top-16 z-40 shadow-lg">
